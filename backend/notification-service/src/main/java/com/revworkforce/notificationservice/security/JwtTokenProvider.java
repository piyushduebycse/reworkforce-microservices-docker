package com.revworkforce.notificationservice.security;
...
public class JwtTokenProvider {
    ...
    public Long getUserIdFromToken(String token) { String id = validate(token).get("userId", String.class); return id != null ? Long.parseLong(id) : null; }
